...
void Submission::loadSubmissions()
{
    ...
    ui->submissionTable->setColumnWidth(0, 50);   // ID
    ui->submissionTable->setColumnWidth(1, 300);  // Titre (agrandi)
    ui->submissionTable->setColumnWidth(2, 180);  // Auteur (agrandi)
    ui->submissionTable->setColumnWidth(3, 150);  // Domaine (agrandi)
    ui->submissionTable->setColumnWidth(4, 110);  // Date (agrandi)
    ui->submissionTable->setColumnWidth(5, 110);  // Statut (agrandi)
    ui->submissionTable->setColumnWidth(6, 120);  // Relecteur (rétréci)
}
