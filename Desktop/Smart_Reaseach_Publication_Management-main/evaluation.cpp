    ...
    , unreadNotifications(0)
{
    ...
    // Vérifier les notifications au démarrage avec un délai
    QTimer::singleShot(500, this, &Evaluation::checkNotifications);
}
...
void Evaluation::markNotificationAsRead(int notificationId)
{
