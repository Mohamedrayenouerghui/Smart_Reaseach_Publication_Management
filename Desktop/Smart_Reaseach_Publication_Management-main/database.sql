...
-- Unified Database Schema (Oracle 12c+ IDENTITY columns)
-- ============================================================

-- ============================================
-- TABLE: USERS
-- (Role column added from friend's project)
-- ============================================
CREATE TABLE USERS (
...
CREATE TABLE SOUMISSION (
    ID_soumission     NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
-- ============================================
-- TABLE: ARTICLE
-- (contenu stores file text for spell/plagiarism check)
-- ============================================
CREATE TABLE ARTICLE (
    ID_article    NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
BEGIN
    DBMS_OUTPUT.PUT_LINE('Base de données unifiée créée avec succès!');
END;
/
